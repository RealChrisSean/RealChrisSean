...
> I build apps I'd use myself, then write down what broke getting there.
...
- [Speak It](https://app.parallellives.ai/speak-it) - Voice-to-text Chrome extension that learns how you talk without storing what you said.
...
- [Journal It](https://app.parallellives.ai/journal) - AI journaling that turns entries into memory, patterns, and eventually your own autobiography.
- [atlasMemory](https://github.com/RealChrisSean/atlasMemory) - AI memory layer experiment with branching and rollbacks.
- [OriginAI](https://app.parallellives.ai/detect) - Chrome extension that catches AI-generated content.
## Latest Blog Posts
